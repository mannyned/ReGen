...
export class ExcelExportService {
  ...
  async generateExcelExport(
    ...
    workbook.creator = 'ReGen Analytics'
    workbook.lastModifiedBy = 'ReGen Analytics'
  ...
  private async addSummarySheet(
    ...
    titleCell.value = 'ReGen Analytics Report'
    ...
    sheet.addRow([])
    sheet.addRow([])
    const footerRow = sheet.addRow(['Generated by ReGen - AI-Powered Social Media Analytics', '', ''])
