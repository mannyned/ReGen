                  ...
                  {upcomingPosts.map((post) => (
                    <div key={post.id} className="border border-gray-200 rounded-lg p-4 hover:border-primary transition-colors">
                      ...
                      <div className="flex gap-2">
                        {/* Edit button - links to Generate page with correct contentId */}
                        {post.contentUploadId && (
                          <Link
                            href={`/generate?contentId=${post.contentUploadId}`}
                            className="flex-1 text-xs py-2 px-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-medium transition-colors flex items-center justify-center gap-1"
                          >
