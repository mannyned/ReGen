          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-40 h-40 flex items-center justify-center mb-6">
                <Image src="/feature-icon.png" alt="All-in-One Repurposing" width={160} height={160} className="object-contain" />
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-40 h-40 flex items-center justify-center mb-6">
                <Image src="/ai-caption-bubble.png" alt="Smart Captions" width={160} height={160} className="object-contain" />
              </div>
              <h3 className="text-2xl font-bold text-text-primary mb-4">
                Smart Captions
              </h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-40 h-40 flex items-center justify-center mb-6">
                <Image src="/voice-shield.png" alt="Brand Voice AI" width={160} height={160} className="object-contain" />
              </div>
              <h3 className="text-2xl font-bold text-text-primary mb-4">
                Brand Voice AI
              </h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-40 h-40 flex items-center justify-center mb-6">
                <Image src="/tap-ripple.png" alt="One-Tap Publish" width={160} height={160} className="object-contain" />
              </div>
              <h3 className="text-2xl font-bold text-text-primary mb-4">
                One-Tap Publish
              </h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-40 h-40 flex items-center justify-center mb-6">
                <Image src="/insight-analytics.png" alt="Insights Dashboard" width={160} height={160} className="object-contain" />
              </div>
              <h3 className="text-2xl font-bold text-text-primary mb-4">
                Insights Dashboard
              </h3>
