        ...
        <div className="max-w-md w-full text-center">
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <p className="text-gray-600 mb-6">
              We sent a {method === 'magic-link' ? 'sign-in link' : 'verification link'} to{' '}
              <span className="font-medium text-gray-900">{email}</span>
            </p>
            <p className="text-sm text-gray-500 mb-6">
              Click the link in the email to {method === 'magic-link' ? 'sign in' : 'verify your account'}.
            ...
            <div className="space-y-3">
              ...
              <Link
                href="/login"
                className="block w-full px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-700"
              >
                Back to sign in
              </Link>
            </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm">
          ...
          {/* Sign Up Form */}
          <form onSubmit={method === 'password' ? handlePasswordSignUp : handleMagicLinkSignUp}>
            <div className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading || (method === 'password' && passwordErrors.length > 0)}
