...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-brand p-4 relative overflow-hidden">
      ...
      <div className={`relative bg-white rounded-3xl shadow-2xl p-8 md:p-10 w-full animate-scale-in transition-all duration-300 ${
        step === 'plan' ? 'max-w-4xl' : 'max-w-md'
      }`}>
        {/* Logo */}
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          <div className={`flex items-center gap-2 ${step === 'plan' ? 'text-primary' : 'text-gray-400'}`}>
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
              step === 'plan' ? 'bg-primary text-white' : 'bg-gray-200 text-gray-500'
            }`}>
              1
            </div>
        ...
        {step === 'plan' && (
          <div className="animate-fade-in">
            <div className="text-center mb-8">
              ...
              <p className="text-text-secondary">Start free, upgrade anytime</p>
            </div>
                  ...
                  >
                    ...
                    {isPopular && (
                      <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                        <span className="bg-gradient-to-r from-primary to-accent-purple text-white text-xs font-bold px-3 py-1 rounded-full">
                          MOST POPULAR
                        </span>
                      </div>
                    )}
                    ...
                    {/* Plan Icon & Name */}
                    <div className="mb-4">
                      <span className="text-3xl">{planData.icon}</span>
                      <h3 className="text-xl font-bold text-text-primary mt-2">{planData.name}</h3>
                    </div>
                    ...
                    <div className="mb-4">
                      {plan === 'free' ? (
                        ...
                        <div>
                          <span className="text-3xl font-bold text-text-primary">${planData.price}</span>
            ...
            >
              <span>Continue with {PLANS[selectedPlan].name}</span>
        ...
        {step === 'details' && (
          <div className="animate-fade-in">
            ...
            <div className="flex items-center justify-center gap-2 mb-6 p-3 bg-gray-50 rounded-xl">
              <span className="text-2xl">{PLANS[selectedPlan].icon}</span>
              <span className="font-bold text-text-primary">{PLANS[selectedPlan].name} Plan</span>
              <span className="text-text-secondary">•</span>
              <span className="text-text-secondary">{PLANS[selectedPlan].priceDisplay}</span>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start pt-2">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 text-primary border-gray-300 rounded focus:ring-primary focus:ring-offset-0"
                />
              ...
              >
                {isLoading ? (
                  ...
                  <span>
                    {selectedPlan === 'free' ? 'Create Free Account' : `Start ${PLANS[selectedPlan].name} Plan`}
                  </span>
                )}
              </button>
            </form>
              ...
              <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-xl">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-blue-800">
                    <span className="font-medium">14-day free trial</span> — You won't be charged until the trial ends. Cancel anytime.
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="my-6 flex items-center">
              ...
              <span className="px-4 text-sm text-text-secondary">or sign up with</span>
              <div className="flex-1 border-t border-gray-200" />
            </div>
