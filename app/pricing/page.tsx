...
const plans: PlanConfig[] = [
  {
    ...
    seats: 1,
    features: [
      { text: '20 uploads per month', included: true },
      { text: '2 platforms (Meta, TikTok)', included: true },
      ...
      { text: 'Brand voice profiles', included: false },
  ...
  },
  {
    ...
    popular: true,
    features: [
      { text: '200 uploads per month', included: true, highlight: true },
      { text: '5 platforms', included: true, highlight: true },
      { text: '30 days analytics history', included: true },
      { text: '1GB storage', included: true },
      { text: 'AI-powered captions', included: true, highlight: true },
      { text: 'Advanced scheduling', included: true, highlight: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'All platforms', included: true, highlight: true },
      { text: '365 days analytics history', included: true },
      { text: '10GB storage', included: true },
      { text: 'AI-powered captions', included: true },
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {[
                    { feature: 'Monthly uploads', free: '20', creator: '200', pro: 'Unlimited' },
                    { feature: 'Platforms', free: '2', creator: '5', pro: 'All' },
                    { feature: 'Analytics history', free: '7 days', creator: '30 days', pro: '365 days' },
                    { feature: 'Storage', free: '100MB', creator: '1GB', pro: '10GB' },
                    { feature: 'Team seats', free: '1', creator: '1', pro: '10' },
                    { feature: 'AI captions', free: false, creator: true, pro: true },
                    { feature: 'Advanced scheduling', free: false, creator: true, pro: true },
                    { feature: 'Brand voice profiles', free: false, creator: true, pro: true },
                    { feature: 'Analytics export', free: false, creator: true, pro: true },
                    { feature: 'Team collaboration', free: false, creator: false, pro: true },
                    { feature: 'Bulk operations', free: false, creator: false, pro: true },
                    { feature: 'API access', free: false, creator: false, pro: true },
